...
const faqs = [
  {
    ...
    answer:
      'يمكنك التسجيل بإنشاء حساب مجاني، أو الشراء السريع بدون حساب بإدخال اسمك ورقم هاتفك. إذا كان لديك حساب، سجّل الدخول أولاً ثم اختر الدورة وطريقة الدفع المناسبة.',
    link: '/courses',
  ...
  },
  {
    ...
    answer:
      'يمكنك الدفع عبر البطاقة الذهبية (إيداهابيا) مباشرة عبر شارجيلي، أو الدفع عند الاستلام مع رسوم توصيل 500 د.ج. سيتواصل معك فريقنا لتأكيد الدفع وإنشاء حسابك إذا لم يكن لديك حساب.',
    link: '/how-it-works',
