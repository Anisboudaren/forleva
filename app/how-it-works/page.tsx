...
const steps = [
  ...
  },
  {
    ...
    description: 'نوفر خيارين للدفع: البطاقة الذهبية (إيداهابيا) عبر شارجيلي، أو الدفع عند الاستلام مع رسوم توصيل 500 د.ج. يمكنك أيضاً الشراء السريع بدون حساب — سيتواصل معك الفريق لتأكيد الدفع وإنشاء حسابك.',
    expandedDescription: 'اختر ما يناسبك: ادفع مباشرة عبر إيداهابيا على شارجيلي، أو اختر الدفع عند الاستلام. إذا لم يكن لديك حساب، يمكنك إتمام الطلب باسمك ورقم هاتفك فقط، وسيتواصل معك فريقنا لإتمام الإجراءات وإنشاء حسابك على المنصة.',
    paymentImages: [
